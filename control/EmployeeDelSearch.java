...
/**
 * 利用者が入力した社員番号から削除確認画面に社員情報を表示する.
 ...
 *
 */
@WebServlet("/EmployeeDelSearch")
public class EmployeeDelSearch extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployeeDelSearch() {
        super();
        // TODO Auto-generated constructor stub
    }

    /**
	 *  社員表の情報を削除する際に削除確認画面に社員情報を表示する.
	 *  <br>EmployeeDelateDaoのsearchEmployeeメソッドを呼ぶ
	 *  <br>社員情報を表示するためにEmployeeDelete.jspにフォワードする.
	 *
	 * @exception E090Exception システムエラー
	 * @exception E070Exception セッションタイムアウトエラー
	 * @exception E012Exception 社員番号が整数でない
	 * @exception E032Exception 社員番号が登録されていない
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       request.setAttribute("em", em);
	    RequestDispatcher dispatch=request.getRequestDispatcher("employeeDelete.jsp");
