...
/**
 * 職種ごとの人数と平均給与を表示する.
 * <br>SlaryDaoから職種ごとの人数と平均給与を受け取る.
 ...
 *
 */
@WebServlet("/JobSalary")
public class JobSalary extends HttpServlet {
    ...
    /**
	 *  職種ごとの人数と平均給与を受け取る.
	 *  <br>SalaryDaoのjobAvgを呼ぶ
	 *  <br>人数と平均を表示するためにをjobSalary.jspにフォワードする.
	 *
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		e.printStackTrace();
    	   ...
    	   RequestDispatcher dispatch=request.getRequestDispatcher("jobSalary.jsp");
