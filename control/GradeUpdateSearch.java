 ...
 *
 */
@WebServlet("/GradeUpdateSearch")
public class GradeUpdateSearch extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public GradeUpdateSearch() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    GradeUpdateDao gd=new GradeUpdateDao();
	    ...
	    RequestDispatcher dispatch=request.getRequestDispatcher("gradeUpdate.jsp");
