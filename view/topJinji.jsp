...
<li><form name="form2" action="DepartmentShow" method="post">
 ...
 <li><form name="form4" action="DepartmentSalary" method="post">
  <a href="#" onClick="document.form4.submit();">部署毎の人数と平均給与</a>
 </form></li>

  <li><form name="form5" action="JobSalary" method="post">
  <a href="#" onClick="document.form5.submit();">職種毎の人数及び平均給与</a>
 </form></li>
 </ul>
</body>
</html>